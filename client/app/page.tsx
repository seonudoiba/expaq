        ...
        <section className="relative w-full h-[600px] flex items-center justify-center">
          ...
          <div className="container relative z-10 px-4 md:px-6 flex flex-col items-center text-center space-y-6">
            ...
            <p className="text-xl text-white/90 max-w-[800px]">
              Connect with local hosts and find unique activities anywhere in
              the world
            </p>
            <HeroFilter />
          </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col md:flex-row justify-between items-center mb-8">
              <div>
                ...
                <p className="text-muted-foreground mt-2">
                  Handpicked countries you&apos;ll love
                </p>
              </div>
              <Link
                href="/countries"
        ...
        <section className="container px-4 md:px-6 py-12 md:py-16 lg:py-20">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground mt-2 max-w-2xl mx-auto">
              We connect adventure seekers with verified local hosts for
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-6 rounded-lg border bg-card">
              ...
              <p className="text-muted-foreground">
                All our hosts and activities are carefully verified for quality
                and safety
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-lg border bg-card">
              ...
              <p className="text-muted-foreground">
                Book activities instantly with our secure and easy-to-use
                platform
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-lg border bg-card">
              ...
              <p className="text-muted-foreground">
                Connect with local hosts who share their passion and expertise
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-muted py-12 md:py-16 lg:py-20">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground mt-2 max-w-2xl mx-auto">
                Hear from people who have discovered amazing experiences through
                Expaq
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
