...
const AppSearchBarMobile: FC<IAppSearchBarMobileProps> = ({
  ...
  // const [{ location }, dispatch]: [DataContextType | null, (args: any) => void] | null = useDataContext();
  ...
  return (
    <>
      ...
      <div className="container block w-full md:hidden">
        <div className="relative flex items-center justify-center h-12 bg-slate-100 rounded-full">
          {searchPage && (
            <Link href="/">
