...
//    }
    public void cancelBooking(Long bookingId) {
//        List<BookedActivity> bookings =
        BookedActivity booking = bookingRepository.findById(bookingId).get();
    ...
    public String saveBooking(Long activityId, BookedActivity bookingRequest) {
        ...
        boolean ActivityIsAvailable = activity.getCapacity() > activity.getBooked_capacity();
