...
const Hero = () => {
  return (
    <section className="relative h-[65vh] md:h-[85vh]">
      <div className="absolute className='m-[-10vh]' w-full bg-gradient-to-b from-transparent-black to-transparent h-28" />
    

      <div className="container">
        <div className="absolute left-0 right-0 md:top-[10%] xl:top-[10%] md:pt-16 pt-8">
          <h1 className="max-w-[400px] xl:max-w-[520px] md:leading-10 md:bg-white rounded-full mx-auto p-2 text-4xl font-bold tracking-wide text-center text-primary mt-8 md:text-3xl ">
          Connect with Locals

          </h1>
          <h1 className="max-w-[650px] xl:max-w-[650px] bg-[#ffffff63] md:mt-6 rounded-full text-primary md:leading-10 mx-auto  text-2xl font-bold tracking-wide mt-4 text-center md:px-0 md:text-3xl">
