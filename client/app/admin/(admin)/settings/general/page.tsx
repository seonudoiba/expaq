...
import { AlertCircle, CheckCircle2, InfoIcon, SaveIcon } from "lucide-react";
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="support-email" defaultValue="support@expaq.com" />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-gray-500">Allow users to leave reviews for activities</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-gray-500">Allow users to message hosts</p>
                    </div>
                    <Switch id="messaging-enabled" defaultChecked />
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label htmlFor="instant-booking-enabled">Enable Instant Booking</Label>
                      <p className="text-sm text-gray-500">Allow immediate booking without host approval</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-gray-500">Allow users to join waitlists for full activities</p>
                    </div>
        ...
        <TabsContent value="appearance">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Customize the look and feel of the ExpAq platform</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="hero-headline" defaultValue="Discover Unique Experiences Around the World" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="hero-subheading">Hero Subheading</Label>
                    <Input id="hero-subheading" defaultValue="Connect with local hosts and find authentic activities" />
                  </div>
                  <div className="space-y-2">
        ...
        <TabsContent value="fees">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure platform fees, host commissions and payment settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <Alert>
                ...
                <AlertDescription>
                  Changes to fee structures will only apply to new bookings after the changes are saved. 
                  Existing bookings will continue to use the previous fee structure.
                </AlertDescription>
              </Alert>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="guest-fee-percentage">Guest Fee Percentage</Label>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="host-fee-percentage">Host Fee Percentage</Label>
                    <div className="flex items-center">
                      <Input 
                ...
                <div className="border rounded-md p-4 mt-2">
                  <h4 className="font-medium mb-2">Tiered Host Fee Structure (Optional)</h4>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="payment-methods">Supported Payment Methods</Label>
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="payment-wallet">Digital Wallet (Apple/Google Pay)</Label>
                      </div>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="cancellation-policy">Default Cancellation Policy</Label>
        ...
        <TabsContent value="emails">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure automated email templates for the platform</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="sender-email" defaultValue="notifications@expaq.com" />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="reply-to-email" defaultValue="support@expaq.com" />
                  </div>
                </div>
              </div>
...
www.expaq.com`} 
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                        <div className="text-sm bg-gray-100 p-2 rounded">{"{{user.firstName}}"}</div>
                        <div className="text-sm bg-gray-100 p-2 rounded">{"{{user.lastName}}"}</div>
                        <div className="text-sm bg-gray-100 p-2 rounded">{"{{user.email}}"}</div>
                        <div className="text-sm bg-gray-100 p-2 rounded">{"{{booking.id}}"}</div>
                        <div className="text-sm bg-gray-100 p-2 rounded">{"{{activity.title}}"}</div>
                        <div className="text-sm bg-gray-100 p-2 rounded">{"{{host.name}}"}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-gray-500">Send booking reminder emails</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-gray-500">Send emails requesting reviews after activities</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-gray-500">Send weekly newsletter with featured activities</p>
                    </div>
