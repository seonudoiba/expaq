    ...
    <section className="relative h-[65vh] md:h-[85vh]">
      ...
      <div className="containe">
        <div className="absolute z-10 left-0 right-0 top-[10%] md:top-[10%] xl:top-[10%] pt-16">
          <h1 className="max-w-[600px] xl:max-w-[520px] md:leading-10 bg-white rounded-full mx-auto px-0 text-2xl font-bold tracking-wide text-center text-primary md:px-0 md:text-3xl xl:text-5xl">
          Connect with Locals

          </h1>
          <h1 className="max-w-[650px] xl:max-w-[650px] bg-primary text-white md:leading-10 mx-auto  text-2xl font-bold tracking-wide mt-4 text-center text-primary md:px-0 md:text-3xl xl:text-4xl">
